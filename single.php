...
<head>
	<title>Digital Biz a Corporate Category Bootstrap responsive WebTemplate | Single :: w3layouts</title>
...
<body>
	<header>
		<div class="header_top" id="home">
			<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
				<a class="navbar-brand" href="index.phpphp">
					...
					<ul class="navbar-nav mx-auto tp-nav">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="error.php">Error Page</a>
							</div>
						</li>
						<li class="nav-item">
	...
	<section class="services">
		<div class="container">
			<h3 class="tittle_w3ls">Single Page</h3>
