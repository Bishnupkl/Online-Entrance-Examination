  ...
  <body>
    ...
    <div class="container">
      	<div class="row">
            ...
            <form>
          		APP ID: <input type="text" class="app_id" value="b91c191d">
            	APP KEY: <input type="text" class="app_key" value="3d61b73125a7d66d8588d8414b6a15a9">
        ...
        <div class="row">
      	...
      	<div class="row">
        	<h5>Response:</h5>
        	<img src="assets1/images/loading.gif" id="loader">
