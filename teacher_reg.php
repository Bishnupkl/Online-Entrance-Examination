...
-webkit-background-size: cover;
    ...
    min-height: 800px;position: relative;margin-top: -36px;">
		<div class="main">
			<h1 class="w3layouts_head">Teacher Registration Form</h1>
				<div class="w3layouts_main_grid">
					<form action="teacher_reg_process.php" method="post" class="w3_form_post">
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							...
							<script>
									...
									xhttp.open("GET.html","getting_hint1.php?id="+str,true);
									xhttp.send();	
					...
					<div class="w3_agileits_main_grid w3l_main_grid" style="margin-top: -10px;">
							<span class="agileits_grid">
								<label>Subject  </label>
