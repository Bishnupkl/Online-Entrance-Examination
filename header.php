		...
		<div class="header_top" id="home" style="margin-top: -18px;">
			<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
				<a class="navbar-brand" href="index.php" style ="margin-left: -30px;">
					<img src="logo.png" width="300px" style="margin-top: -50px;margin-left: -30px;"></a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: -50px;">
					<ul class="navbar-nav mx-auto tp-nav text-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="student_reg.php">Student</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="teacher_reg.php">Teacher</a>
							</div>
						</li>
						<li class="nav-item">
					...
					<form action="#" method="post" class="form-inline my-2 my-lg-0 search">
						<input class="form-control mr-sm-2" type="search" placeholder="Search here..." name="Search" required="" style="width: 200px;margin-left: 15px;">
						<button style="background-color: black;margin-left: 10px;" class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
					</form>
